...
export const BackgroundBeamsWithCollision = ({
      ...
      const generateBeams = (width: number) => {
        ...
        const newBeams = Array.from({ length: beamCount }, () => {
            ...
            return {
                ...
                delay: Math.random() * 4,
                className:
                    validHeights[Math.floor(Math.random() * validHeights.length)],
            };
        });
        setBeams(newBeams);
    };
    ...
    useEffect(() => {
        const updateBeams = () => {
            ...
            if (!containerWidth || Math.abs(width - containerWidth) > 100) {
        ...
        updateBeams(); // initial render

        const debouncedResize = debounce(updateBeams, 300);
